                               ...
                               unsigned long arg2, unsigned long result_code)
{
    ...
    if (control_code == SUKISU_KPM_LOAD) {
        ...
        if (!access_ok(VERIFY_READ, arg1, 255)) {
            goto invalid_arg;
        }
        ...
        if (arg2 != 0) {
            if (!access_ok(VERIFY_READ, arg2, 255)) {
                goto invalid_arg;
            }
        ...
        if (!access_ok(VERIFY_READ, arg1, sizeof(kernel_name_buffer))) {
            goto invalid_arg;
        }
        ...
        if (!access_ok(VERIFY_WRITE, arg2, size)) {
            goto invalid_arg;
        }
        ...
        if (!access_ok(VERIFY_WRITE, arg2, len)) {
            goto invalid_arg;
        }
        ...
        if (!access_ok(VERIFY_READ, arg1, sizeof(kpm_name))) {
            goto invalid_arg;
        }

        if (!access_ok(VERIFY_READ, arg2, sizeof(kpm_args))) {
            goto invalid_arg;
        }
...
int do_kpm(void __user *arg)
{
    ...
    if (!access_ok(VERIFY_READ, cmd.control_code, sizeof(int))) {
        pr_err("kpm: invalid control_code pointer %px\n",
               (void *)cmd.control_code);
        return -EFAULT;
    }

    if (!access_ok(VERIFY_WRITE, cmd.result_code, sizeof(int))) {
